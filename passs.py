...
cur.execute("create table if not exists passwords (NO int not null primary key auto_increment,Username not null varchar(),Password varchar(),Email_linked varchar(),App_name varchar() )")
